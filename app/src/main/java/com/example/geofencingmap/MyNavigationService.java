package com.example.geofencingmap;
...
public class MyNavigationService extends Service {
    ...
    private static final String PACKAGE_NAME ="com.example.geofencingmap";
    private final IBinder mBinder = (IBinder) new LocalBinder();
    private static final String TAG = MyNavigationService.class.getSimpleName();
    private static final String CHANNEL_ID = "channel_01";
    static final String ACTION_BROADCAST = PACKAGE_NAME + ".broadcast";
    static final String EXTRA_LOCATION = PACKAGE_NAME + ".location";
    static final String EXTRA_ADDRESS = PACKAGE_NAME;
    ...
    public void onCreate() {
        ...
        mLocationCallback = new LocationCallback() {
            ...
            public void onLocationResult(LocationResult locationResult) {
                ...
                onNewLocation(locationResult.getLastLocation(), address);
            }
        };
    ...
    private Notification getNotification() {
        ...
        CharSequence text = Utils.getLocationText(mLocation,address);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this)
                ...
                .addAction(R.drawable.ic_cancel_black_24dp, getString(R.string.remove_location_updates),
    ...
    private void getAddress(Double lat, Double log)
    {
        ...
        try {
            addresses=geocoder.getFromLocation(lat,log,5);
    ...
    @RequiresApi(api = Build.VERSION_CODES.JELLY_BEAN)
    private void onNewLocation(Location location, String address) {
